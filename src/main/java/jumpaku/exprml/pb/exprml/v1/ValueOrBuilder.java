...
public interface ValueOrBuilder extends
   ...
   * @return The type.
   */
  jumpaku.exprml.pb.exprml.v1.Value.Type getType();
   ...
   */
  java.util.List<jumpaku.exprml.pb.exprml.v1.Value> 
      getArrList();
  /**
   * <pre>
   * arr has an array value if the type is TYPE_ARR.
   ...
   * <code>repeated .exprml.v1.Value arr = 5 [json_name = "arr"];</code>
   */
  jumpaku.exprml.pb.exprml.v1.Value getArr(int index);
  /**
   * <pre>
   * arr has an array value if the type is TYPE_ARR.
   * </pre>
   ...
   * <code>repeated .exprml.v1.Value arr = 5 [json_name = "arr"];</code>
   */
  java.util.List<? extends jumpaku.exprml.pb.exprml.v1.ValueOrBuilder> 
      getArrOrBuilderList();
  /**
   * <pre>
   * arr has an array value if the type is TYPE_ARR.
   ...
   * <code>repeated .exprml.v1.Value arr = 5 [json_name = "arr"];</code>
   */
  jumpaku.exprml.pb.exprml.v1.ValueOrBuilder getArrOrBuilder(
      int index);
  ...
  java.util.Map<java.lang.String, jumpaku.exprml.pb.exprml.v1.Value>
  getObj();
  /**
   * <pre>
   * obj has an object value if the type is TYPE_OBJ.
...
jumpaku.exprml.pb.exprml.v1.Value defaultValue);
   ...
   * <code>map&lt;string, .exprml.v1.Value&gt; obj = 6 [json_name = "obj"];</code>
   */
  jumpaku.exprml.pb.exprml.v1.Value getObjOrThrow(
      java.lang.String key);
}
