...
public interface DefStackOrBuilder extends
   ...
   * @return The parent.
   */
  jumpaku.exprml.pb.exprml.v1.DefStack getParent();
  /**
   * <pre>
   * Parent definition list.
   * </pre>
   ...
   * <code>.exprml.v1.DefStack parent = 1 [json_name = "parent"];</code>
   */
  jumpaku.exprml.pb.exprml.v1.DefStackOrBuilder getParentOrBuilder();
   ...
   * @return The def.
   */
  jumpaku.exprml.pb.exprml.v1.Eval.Definition getDef();
  /**
   * <pre>
   * Definition.
   * </pre>
   ...
   * <code>.exprml.v1.Eval.Definition def = 2 [json_name = "def"];</code>
   */
  jumpaku.exprml.pb.exprml.v1.Eval.DefinitionOrBuilder getDefOrBuilder();
}
