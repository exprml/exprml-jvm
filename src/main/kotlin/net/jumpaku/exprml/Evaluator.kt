...
import net.jumpaku.exprml.pb.exprml.v1.EvaluateOutput.Status
    ...
    fun evaluateOpUnary(input: EvaluateInput): EvaluateOutput {
        ...
        return when (op.op) {
            ...
            OpUnary.Op.FLOOR -> {
                ...
                evaluateOutput { value = numValue(floor(operand.num)) }
            }
            ...
            OpUnary.Op.CEIL -> {
                ...
                evaluateOutput { value = numValue(ceil(operand.num)) }
            }
